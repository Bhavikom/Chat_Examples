...
import com.dcdroid.chatapp.Model.GroupList.GroupList;
import com.dcdroid.chatapp.Model.GroupUsers.GroupUser;
import com.dcdroid.chatapp.Model.GroupUsersList.GroupUsersList;
import com.dcdroid.chatapp.Model.Login.LoginAPI;
import com.dcdroid.chatapp.Model.SaveMessage.SaveMessage;
...
public interface Webservices {
    ...
    @GET("/User.aspx")
    public void getSaveMessages(@QueryMap Map<String, String> map, Callback<SaveMessage> callback);
    /*7. Show Message*/
    /*8. Bad Filter*/
