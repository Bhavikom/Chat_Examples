...
public class MyXMPP {
    ...
    public void sendMessage(ChatMessage chatMessage) {
        ...
        if (!chat_created) {
            Mychat = ChatManager.getInstanceFor(connection).createChat(
                    chatMessage.receiver + "@localhost"
                            ,
                    mMessageListener);
            chat_created = true;
        }
    ...
    private class MMessageListener implements ChatMessageListener {
        ...
        public void processMessage(final org.jivesoftware.smack.chat.Chat chat,
            ...
            Log.i("MyXMPP_MESSAGE_LISTENER", "Xmpp bmessage received: '"
                    + message);

            System.out.println("Body-----"+message.getBody() + " sender : "+message.getFrom() + " receipt : "+message.getTo());
